...
## Repository-Specific Focus (Events)

- Treat this service as the owner of events, routes, and event-route linkage.
- Validate consistency between route resources and their parent event context for create/update/delete flows.
- Keep endpoint contracts stable for map-oriented frontend consumers.
- For route-related changes, include readiness-aware validation because service warm-up can cause short transient failures.
